      ...
      <div className="footer" id="contact-us">
        ...
        >
          ...
          <a href="mailto: sales@arizg.com">
            <i className="fa fa-envelope"></i>sales@arizg.com
          </a>
          <br />
          <a href="https://arizg.com">
            <i className="fa fa-globe"></i>www.arizg.com
          </a>
          <br />
          <a href="https://goo.gl/maps/cuaYKtMnch9WsQz87" className="address">
            <i className="fa fa-map-marker-alt" aria-hidden="true"></i>Kyrgyz
            Republic c. Bishkek, M.GORKIY 29/1 VEFA BUSINESS CENTER C-BLOCK,
            office 602
          </a>
          <br />
        </div>
